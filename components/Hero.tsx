    ...
    <section className="pt-12 md:pt-24 flex flex-col md:flex-row items-center gap-12 md:gap-20">
        ...
        <div className="space-y-8 pt-4">
          ...
          <div className="flex flex-col items-center md:items-start gap-3">
            ...
            <div className="flex gap-4">
              ...
              <button className="flex items-center gap-3 bg-gray-900 text-white px-5 py-2 rounded-xl border-[3px] border-gray-900 hover:translate-y-[-4px] hover:shadow-[4px_4px_0px_0px_#00c7fc] active:translate-y-0 active:shadow-none transition-all duration-200 shadow-[4px_4px_0px_0px_rgba(0,0,0,0.3)]">
      ...
      <div className="flex-1 w-full max-w-md relative md:mt-0">
        ...
        <div className="relative w-full max-w-[600px] h-[600px] transform scale-[0.85] sm:scale-95 md:scale-[0.85]">
          ...
          <div className="absolute top-12 -left-20 sm:-left-12 w-[280px] h-[520px] bg-cream border-[4px] border-ink rounded-[36px] overflow-hidden shadow-neo transform -rotate-6 z-10 flex flex-col">
            {/* Status Bar */}
          ...
          <div className="absolute top-12 -right-20 sm:-right-12 w-[280px] h-[520px] bg-cream border-[4px] border-ink rounded-[36px] overflow-hidden shadow-neo transform rotate-6 z-20 flex flex-col">
            {/* Status Bar */}
            <div className="h-8 border-b-[3px] border-ink flex justify-between items-center px-4 bg-white flex-shrink-0">
              <Heart size={16} fill="#FF4757" className="text-primary" />
              <div className="flex gap-1">
