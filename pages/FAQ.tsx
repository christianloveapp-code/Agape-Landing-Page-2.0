                            ...
                            <div>
                                ...
                                <div className="text-gray-600">
                                    ...
                                    <ul className="list-disc list-inside space-y-1 ml-2">
                                        <li><strong>Unlimited Super Likes:</strong> Superlike to directly message any user, skip the waiting period hoping they like you back to message.</li>
                                        ...
                                        <li><strong>Unlimited Messages:</strong> Send as many messages as you'd like.</li>
                                    </ul>
                                </div>
                            </div>
                            <div>
